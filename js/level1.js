...
console.log('New Message : Hello World!');
...
let numberOne;
let numberTwo;
console.log("variableName is " + numberOne);
console.log("variableName is " + numberTwo);
...
// alert("Multiple : " + multipleOfNumbers);
...
console.log("Added result of number1 and number2: " + add(2, 3));
...
console.log("Substraction result of number1 and number2: " + substract(5, 1));
...
const bool = (5 > 1);
console.log("Truthy: " + bool);
console.log("Falsy: " + !bool);
let Truthy = !false;
