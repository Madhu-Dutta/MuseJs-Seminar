...
// console.log(headerTitle.textContent = 'ourTitle');
...
console.log("Length of media link: " + mediaLinks.length);
...
for (let i = 0; i < mediaLinks.length; i++) {
    console.log("Each media links : " + mediaLinks[i]);
}
...
for (let i = 0; i < header.length; i++) {
    console.log(header[i].textContent = 'Not Good with Header Names');
}
...
const pageNode = document.querySelector('h1');
const newHeader = document.createElement('h2');

const paragraphText = document.createTextNode('I am a new Header!');
newHeader.appendChild(paragraphText);
pageNode.appendChild(newHeader);


const imgNode = document.querySelector('h1');
console.log(imgNode);
const newImg = document.createElement('img');

const newImgSrc = 'img/kittens.jpeg';
newImg.src = newImgSrc;
imgNode.appendChild(newImg);

img.style.borderRadius = "50px";
newImg.style.borderRadius = "50px";
newImg.style.border = "12px solid black";
